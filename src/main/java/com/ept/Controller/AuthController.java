...
//import com.ept.Entity.LoginRequest;
//import com.ept.Entity.LoginResponse;
//import com.ept.Entity.User;
//import com.ept.Service.AuthUserService;
//
//
//@RestController
...
////			  Optional<LoginResponse> response = userService.login(request.getName(), request.getEmail());
////		  
////		  if (response.isPresent()) {
////			  return ResponseEntity.ok(response.get()); 
////			} else {
////		       return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body("Invalid name or email"); 
////		     }
////		 
////		  }
//	    
...
////		  
////		  Optional<LoginResponse> response = userService.login(email, role);
////		  
////		  if (response.isPresent()) {
////			  return ResponseEntity.ok(response.get());
////			  } 
////		  else
////		    { 
////			  return ResponseEntity .status(401) .body("Invalid email or role"); 
////		  } 
////		 }
//	    @PostMapping("/login")
//	    public ResponseEntity<?> login(@RequestBody LoginRequest loginRequest) {
